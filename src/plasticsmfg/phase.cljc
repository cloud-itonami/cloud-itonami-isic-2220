(ns plasticsmfg.phase
  "Phase 0->3 staged rollout for the plastics-products plant-operations
  coordination actor.
  ...
  consequence (an injection-molding/extrusion/blow-molding-line
  ...
  `plasticsmfg.governor`'s `line-actuate-blocked-violations` HARD-blocks
...
(defn verdict->disposition
  "Map a Plastics Plant Operations Governor verdict to a base
