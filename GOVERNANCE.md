...
`cloud-itonami-isic-2220` is an OSS open-business blueprint for plastics-products plant operations coordination.

## Maintainers
Maintainers may merge changes that preserve these invariants:
- a molding/extrusion/blow-molding-equipment action the governor refuses is never dispatched to hardware.
- the Plastics Plant Operations Governor remains independent of the advisor.
...
- bypassing molding/extrusion/blow-molding-equipment-control or record policy checks
