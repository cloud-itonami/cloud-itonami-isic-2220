# Operator Quickstart — Manufacture of Plastics Products

Shortest path from clone to a verified local dry-run for **ISIC 2220** (`cloud-itonami-isic-2220`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-2220.git
cd cloud-itonami-isic-2220
```
...
- Blueprint governor key: `clamp-force-governor`
- Likely source path: `moldworks.governor.cljc`
